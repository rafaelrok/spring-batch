package br.com.rafaelvieira.contasbancariasjob.reader;
...
public class LeituraClientesReaderConfig {
	@Bean
	JdbcPagingItemReader<Cliente> leituraClientesReader(
	...
	@Bean
	SqlPagingQueryProviderFactoryBean queryProvider(@Qualifier("appDataSource") DataSource dataSource) {
